 ...
 (function(b) {
    Galleria.addTheme({
        ...
        init: function(c) {
            ...
            c._toggleInfo === !0 ? d.bind(f,
            function() {
                d.toggle()
            }) : (d.show(), this.$("info-link, info-close").hide());
            this.bind("thumbnail",
            function(a) {
                e ? b(a.thumbTarget).css("opacity", a.index == c.show ? 1: 0.6) : (b(a.thumbTarget).css("opacity", 0.6).parent().hover(function() {
                    b(this).not(".active").children().stop().fadeTo(100, 1)
                },
                function() {
                    b(this).not(".active").children().stop().fadeTo(400, 0.6)
                }), a.index === c.show && b(a.thumbTarget).css("opacity", 1))
            });
            this.bind("loadstart",
            function(a) {
